...
namespace Tapecorps.GameDevelopmentKit
{
    public static class GDK2{
        ...
        public static string CombineStringArray(this string[] array)
        {
            string result = "";
        ...
        public static string CombineStringArray(this int[] array)
        {
            string result = "";
    ...
    public static class Calculations
    {
        ...
        public static Vector2Int ConvertWorldToGridInt(Vector3 worldPosition, Vector2 tileSize)
        {
            // Calculate conversion factors based on your tile arrangement
            float tileWidth = tileSize.x;  // Width of a single tile - 1f
            float tileHeight = tileSize.y; // Height of a single tile - 0.5f

            // Calculate grid position based on the isometric projection
            ...
            return new Vector2Int(gridX, gridY); // Assuming z remains the same
        }

        public static Vector2 ConvertWorldToGrid(Vector3 worldPosition, Vector2 tileSize)
        {
            // Calculate conversion factors based on your tile arrangement
            float tileWidth = tileSize.x;  // Width of a single tile - 1f
            float tileHeight = tileSize.y; // Height of a single tile - 0.5f
            ...
            return new Vector2(x, y); // Assuming z remains the same
        }
